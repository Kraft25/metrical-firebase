                    ...
                    <Card className="bg-accent/10 border-accent shadow-xl sticky top-8">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-3 pt-4">
                                ...
                                <div className="flex items-center gap-3"> <Sprout className="h-5 w-5 text-primary" /> <p><span className="font-bold text-xl text-foreground">{calculationResult.totalMaterials.sand.toFixed(2)}</span> m³ de sable</p> d</div>
